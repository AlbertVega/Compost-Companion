                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          _buildValueRow('Carbon Content', '${controller.totalCarbon.toStringAsFixed(2)} kg'),
                          _buildValueRow('Nitrogen Content', '${controller.totalNitrogen.toStringAsFixed(2)} kg'),
                          _buildValueRow('Total Weight', '${controller.totalVolume.toStringAsFixed(2)} kg'),
